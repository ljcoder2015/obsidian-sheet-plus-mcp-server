...
import { registerObsidianSheetPlusAddFilterToolHandler } from "./tools/obsidianSheetPlusAddFilterTool/index.js";
import { registerObsidianSheetPlusRemoveFilterToolHandler } from "./tools/obsidianSheetPlusRemoveFilterTool/index.js";
import { registerObsidianSheetPlusGetFilterToolHandler } from "./tools/obsidianSheetPlusGetFilterTool/index.js";
import { registerObsidianSheetPlusSetFilterCriteriaToolHandler } from "./tools/obsidianSheetPlusSetFilterCriteriaTool/index.js";
...
async function createMcpServerInstance(
  ...
  try {
    ...
    await registerObsidianSheetPlusAddFilterToolHandler(server, obsidianSheetPlusService);
    await registerObsidianSheetPlusRemoveFilterToolHandler(server, obsidianSheetPlusService);
    await registerObsidianSheetPlusGetFilterToolHandler(server, obsidianSheetPlusService);
    await registerObsidianSheetPlusSetFilterCriteriaToolHandler(server, obsidianSheetPlusService);
