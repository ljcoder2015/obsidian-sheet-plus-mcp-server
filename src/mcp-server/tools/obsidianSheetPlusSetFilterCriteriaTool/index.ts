...
import { registerObsidianSheetPlusSetFilterCriteriaTool } from "./registration.js";
 ...
 */
export async function registerObsidianSheetPlusSetFilterCriteriaToolHandler(
  server: McpServer,
  obsidianSheetPlusService: ObsidianSheetPlusRestApiService,
): Promise<void> {
  await registerObsidianSheetPlusSetFilterCriteriaTool(server, obsidianSheetPlusService);
}
