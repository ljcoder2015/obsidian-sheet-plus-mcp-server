...
import { registerObsidianSheetPlusGetWorkbookDataTool } from "./registration.js";
 ...
 */
export async function registerObsidianSheetPlusGetWorkbookDataToolHandler(
  server: McpServer,
  obsidianSheetPlusService: ObsidianSheetPlusRestApiService,
): Promise<void> {
  await registerObsidianSheetPlusGetWorkbookDataTool(server, obsidianSheetPlusService);
}
