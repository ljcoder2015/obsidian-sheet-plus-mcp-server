...
export async function registerObsidianSheetPlusClearAllConditionalFormattingTool(
  server: any,
  ...
  await ErrorHandler.tryCatch(async () => {
    server.registerTool(
      ...
      async (params: z.infer<typeof ObsidianSheetPlusClearAllConditionalFormattingInputSchema>) => {
        ...
        return await ErrorHandler.tryCatch(async () => {
          const response = await clearAllConditionalFormatting(
