...
import { registerObsidianSheetPlusClearHyperlinksTool } from "./registration.js";
 ...
 */
export async function registerObsidianSheetPlusClearHyperlinksToolHandler(
  server: McpServer,
  obsidianSheetPlusService: ObsidianSheetPlusRestApiService,
): Promise<void> {
  await registerObsidianSheetPlusClearHyperlinksTool(server, obsidianSheetPlusService);
}
