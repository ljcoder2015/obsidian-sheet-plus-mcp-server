...
import { registerObsidianSheetPlusAddFilterTool } from "./registration.js";
 ...
 */
export async function registerObsidianSheetPlusAddFilterToolHandler(
  server: McpServer,
  obsidianSheetPlusService: ObsidianSheetPlusRestApiService,
): Promise<void> {
  await registerObsidianSheetPlusAddFilterTool(server, obsidianSheetPlusService);
}
