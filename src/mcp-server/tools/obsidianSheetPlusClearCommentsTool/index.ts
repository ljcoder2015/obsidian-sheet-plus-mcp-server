...
import { registerObsidianSheetPlusClearCommentsTool } from "./registration.js";
 ...
 */
export async function registerObsidianSheetPlusClearCommentsToolHandler(
  server: McpServer,
  obsidianSheetPlusService: ObsidianSheetPlusRestApiService,
): Promise<void> {
  await registerObsidianSheetPlusClearCommentsTool(server, obsidianSheetPlusService);
}
